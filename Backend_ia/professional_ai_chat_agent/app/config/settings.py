...
class Settings:
    ...
    CORS_ORIGINS: str = os.getenv("CORS_ORIGINS", "https://www.report-elo.com,https://report-elo.com,https://frontend-eight-beta-69.vercel.app,http://localhost:4200,http://localhost:8080,http://127.0.0.1:4200,http://127.0.0.1:8080")
